...
public class GestorMatriculas extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    for (int i = 1; i <= 3; i++) {
	        out.println("Matrícula " + i + ":<br>");
	        out.println("Nombre de la asignatura: <input type=\"text\" name=\"nombreAsignatura" + i + "\"><br>");
	        out.println("Nota: <input type=\"text\" name=\"nota" + i + "\"><br><br>");
	    }
